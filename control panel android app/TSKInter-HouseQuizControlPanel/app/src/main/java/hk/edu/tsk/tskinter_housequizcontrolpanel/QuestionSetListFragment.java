...
/**
 * A list fragment representing a list of Question Sets. This fragment
 * also supports tablet devices by allowing list items to be given an
 * 'activated' state upon selection. This helps indicate which item is
 * currently being viewed in a {@link QuestionSetDetailFragment}.
 * <p>
...
public class QuestionSetListFragment extends ListFragment {
     ...
     */
    public QuestionSetListFragment() {
    }
