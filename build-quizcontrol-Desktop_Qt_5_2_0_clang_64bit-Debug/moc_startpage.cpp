...
#include "../quizcontrol/startpage.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Startpage_t, stringdata) + ofs \
...
const QMetaObject Startpage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Startpage.data,
      qt_meta_data_Startpage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Startpage.stringdata))
